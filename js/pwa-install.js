  ...
  const html = `
    <div class="pwa-prompt-container" id="pwa-custom-install-prompt">
      ...
      <div class="pwa-prompt-text">
        <h4 class="pwa-prompt-title">DevPay অ্যাপ ইনস্টল করুন</h4>
        <p class="pwa-prompt-desc">হোম স্ক্রিনে সেভ করে সহজেই ব্যবহার করুন।</p>
      </div>
      <div class="pwa-prompt-actions">
        <button class="pwa-btn-install" id="pwa-custom-install-btn">ইনস্টল</button>
        <button class="pwa-btn-close" id="pwa-custom-close-btn" aria-label="বন্ধ করুন">✕</button>
      </div>
    </div>
  `;
